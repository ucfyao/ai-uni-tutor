    ...
    return (
        <Box bg="white" mih="100vh">
                ...
                <Container size="lg">
                    <Group justify="space-between">
                        <Group gap="xs">
                            ...
                            <Text fw={700} size="lg" c="dark.9">AI Tutor</Text>
                            <Badge variant="light" color="violet">Shared Chat</Badge>
                        </Group>
                        <Button component="a" href="/login" variant="light" color="violet" size="xs" leftSection={<LogIn size={14} />}>
                            Sign In to Chat
                        </Button>
                    </Group>
                </Container>
            ...
            <Container size="md" py="xl">
                <Stack gap="xl">
                    <Box>
                        <Title order={1} size="h2" mb="xs">{session.title || session.course.code}</Title>
                        <Group justify="space-between">
                                ...
                                >
                                    <Box
                                        ...
                                        style={{ 
                                            ...
                                            borderTopLeftRadius: msg.role === 'assistant' ? 0 : 'var(--mantine-radius-md)',
                                        }}
                                    >
                                        <Text c={msg.role === 'user' ? 'dark.9' : 'dark.8'} size="sm" style={{ whiteSpace: 'pre-wrap' }}>
                                            <ReactMarkdown
                                                ...
                                                components={{
                                                    code: ({node, inline, className, children, ...props}: any) => {
                                                        ...
                                                        return !inline && match ? (
                                                            ...
                                                            <code className={className} style={{ background: 'var(--mantine-color-gray-2)', padding: '2px 4px', borderRadius: 4 }} {...props}>
                                                                {children}
                                                            </code>
                                                        )
                                                    }
