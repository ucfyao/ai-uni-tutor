            ...
            <Stack gap="md">
              <TextInput 
                ...
                styles={{
                    ...
                    input: { backgroundColor: '#f8fafc', border: '1px solid #e2e8f0', transition: 'all 0.2s' }
                }}
              />
              ...
              <Button 
                ...
                mt="sm"
                styles={{
                    root: { boxShadow: '0 10px 20px -5px rgba(67, 56, 202, 0.4)', transition: 'transform 0.2s' },
